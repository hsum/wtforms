...
class SelectFieldTest(TestCase):
    class F(Form):
        ...
        d = SelectField(
            choices=[
                ('a', 'hello', False, {'data-image': 'hello-icon'}),
                ('b', 'bye', False, {'data-image': 'bye-icon'}),
                ('b1', 'bye', False, {'data-image': 'bye-icon'}),
                ('b2', 'bye', False, {'data-image': 'bye-icon'}),
            ],
            default='a',
            render_kw = {
        ...
        e = SelectField(
            choices=[
                ('a', 'hello', False, {'data-image': 'hello-icon'}),
                ('b', 'bye', False, {'data-image': 'bye-icon'}),
                ('b1', 'bye', False, {'data-image': 'bye-icon', 'disabled': True}),
                ('b2', 'bye', False, {'data-image': 'bye-icon'}),
            ],
            default='a',
            render_kw = {
        ...
        f = SelectField(
            choices=[
                ('a', 'hello', False, {'data-image': 'hello-icon', 'data-important-fact': '1'}),
                ('b', 'bye', False, {'data-image': 'bye-icon', 'data-important-fact': '1'}),
                ('b1', 'bye', False, {'data-image': 'bye-icon', 'data-important-fact': '2'}),
                ('b2', 'bye', False, {'data-image': 'bye-icon', 'data-important-fact': '3'}),
            ],
            default='a',
            render_kw = {
